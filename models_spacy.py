...
class SpacyModel:
    ...
    def importCorpora(self, corpora_path: Union[str, bytes, os.PathLike], col: str, annotation_cols: list[str] = []):
        """Imports Excel or CSV file with corpora in the specified column and processes it using the loaded SpaCy model.
        Processed results are appended to the class instance in both doclist (for immediate use) and docbin (for export)
    ...
    def exportDocs(self, custom_name: Union[str, bytes, os.PathLike] = ""):
        ...
        else: # Otherwise use prefix of last import 
